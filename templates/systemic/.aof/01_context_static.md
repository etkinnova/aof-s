# Contexto estático — Nivel 2 (Sistémico)
...
- lint: `pnpm lint`
- migrate: `pnpm migrate:up`

## Reglas
1. No modificar `schema.sql` sin PR aprobado.
2. Usar tipos generados desde OpenAPI.
3. Toda migración debe ser transaccional y con rollback validado.
...
| Guía de deploy | docs/deploy/README.md |