# Contexto estático — Nivel 1 (Ultra‑Light)

<!--
  Este archivo contiene la información inmutable de tu proyecto.
  El agente lo lee en cada sesión para entender tu stack, comandos y reglas.
